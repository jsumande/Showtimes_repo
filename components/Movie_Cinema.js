...
export default class MovieCity extends Component  {
    ...
    componentDidMount() {    
      ...
      .then(() => {
        ...
        fetch('https://liveapper.com/movies/times?date='+global.today+'&movieid='+this.props.route.params.imdb+'&cinemaid='+this.props.route.params.cinema_id
           ,{
                method: 'GET',
                headers: {
                Accept: 'application/json',
        ...
        fetch('https://liveapper.com/movies/times?date='+global.tomorrow+'&movieid='+this.props.route.params.imdb+'&cinemaid='+this.props.route.params.cinema_id
          ,{
               method: 'GET',
               headers: {
               Accept: 'application/json',
         ...
         fetch('https://liveapper.com/movies/times?date='+global.nextday+'&movieid='+this.props.route.params.imdb+'&cinemaid='+this.props.route.params.cinema_id
         ,{
              method: 'GET',
              headers: {
              Accept: 'application/json',
    ...
    render(){
        const { mall_data,movie_data, isLoading } = this.state;
            ...
            <View style={{flex:1,backgroundColor:'#131313'}}>
                ...
                <View style={{flexDirection:'row', marginTop: 10}}>
                 <Icon.Button name="arrow-left" backgroundColor="#131313" size={20} color="white" 
                    onPress={() => this.props.navigation.navigate('Mall',{mall_name : this.props.route.params.mall_name,id : this.props.route.params.id})}/>

                        <TouchableOpacity onPress={() => this.props.navigation.navigate('Mall',{mall_name : this.props.route.params.mall_name,id : this.props.route.params.cinema_id})}>
                    ...
                    <ImageBackground source={{uri:this.state.Img_info}} style={{resizeMode:'cover',flex:1}}>
                        <ScrollView style={{flex:1,backgroundColor:'rgba(0,0,0,0.8)'}}>
                            ...
                            {/* <View style={{paddingTop:10,marginLeft:10,marginRight:10,alignContent:'flex-start'}}>
                                ...
                                <View style={{width:'100%'}}>
                                    <Text style={{color:'white',fontSize:12}}>Popularity : {movie_data[0].popularity}
                                    </Text>
                                </View>      
